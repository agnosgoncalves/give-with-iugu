			...
			switch ( $current_section ) {
				...
				case 'iugu':
					$settings = array(
							...
							array(
								'type' => 'title',
								'id'   => 'give_title_gateway_settings_5',
							),
							array(
								'name' => __( 'Token User', 'give' ),
								'desc' => __( 'add user token.', 'give' ),
								'id'   => 'iugu_user_token',
								'type' => 'text',
							),
							array(
								'name' => __( 'Token Live', 'give' ),
								'desc' => __( 'add live token.', 'give' ),
								'id'   => 'iugu_live_token',
								'type' => 'text',
							),
							array(
								'name' => __( 'Token Test', 'give' ),
								'desc' => __( 'add test token.', 'give' ),
								'id'   => 'iugu_test_token',
								'type' => 'text',
							),
							array(
								'name' => __( 'Enabled testing module', 'give' ),
								'desc' => __( 'please no enabled testing module in production.', 'give' ),
								'id'   => 'iugu_test_enabled',
								'type' => 'checkbox',
							),
							array(
								'name' => __( 'Name', 'give' ),
								'desc' => __( 'used in invoice generation', 'give' ),
								'id'   => 'iugu_account_name',
								'type' => 'text',
							),
							array(
								'name' => __( 'Phone', 'give' ),
								'desc' => __( 'used in invoice generation', 'give' ),
								'id'   => 'iugu_account_phone',
								'type' => 'text',
							),
							array(
								'name' => __( 'Phone Prefix', 'give' ),
								'desc' => __( 'used in invoice generation', 'give' ),
								'id'   => 'iugu_account_phone_prefix',
								'type' => 'number',
							),
							array(
								'name' => __( 'Email', 'give' ),
								'desc' => __( 'used in invoice generation', 'give' ),
								'id'   => 'iugu_account_email',
								'type' => 'email',
							),
							array(
								'name' => __( 'CPF/CNPJ', 'give' ),
								'desc' => __( 'used in invoice generation', 'give' ),
								'id'   => 'iugu_account_ssn',
								'type' => 'number',
							),
							array(
								'name' => __( 'CEP', 'give' ),
								'desc' => __( 'used in invoice generation', 'give' ),
								'id'   => 'iugu_account_zip_code',
								'type' => 'number',
							),
							array(
								'name' => __( 'State', 'give' ),
								'desc' => __( 'used in invoice generation', 'give' ),
								'id'   => 'iugu_account_state',
								'type' => 'text',
							),
							array(
								'name' => __( 'City', 'give' ),
								'desc' => __( 'used in invoice generation', 'give' ),
								'id'   => 'iugu_account_city',
								'type' => 'text',
							),
							array(
								'name' => __( 'Street', 'give' ),
								'desc' => __( 'used in invoice generation', 'give' ),
								'id'   => 'iugu_account_street',
								'type' => 'text',
							),
							array(
								'name' => __( 'Street Number', 'give' ),
								'desc' => __( 'used in invoice generation', 'give' ),
								'id'   => 'iugu_account_street_number',
								'type' => 'number',
							),
							array(
								'type' => 'sectionend',
